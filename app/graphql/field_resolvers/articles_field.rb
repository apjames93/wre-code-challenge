  ...
  module ArticlesField
    def self.included(child_class)
      child_class.field :articles, [Types::ArticleType], null: true do
        description 'Returns the most recent 25 articles. Available arguments are: title, description, user_id, or none at all. If any of the arguments are given, it will apply them as a where clause.'
